...
<html>
  ...
  <section class="hero-section">
    <div class="container">
      ...
      <div class="text-wrapper align-center">
        <h1 class="mbr-section-title mbr-fonts-style mb-3 mt-4 display-1"><strong>Elevate It to the Next Level</strong></h1>
  ...
  <section class="pricing-section bg-light py-5">
    <div class="container">
        <h2 class="text-center mb-5">Choose a Plan That Works for You</h2>
        <div class="row">
            <div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h3 class="card-title">Trenches</h3>
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <li>15 swipes daily</li>
                            <li>Ability to filter age and gender</li>
                            <li>Trenches can only see trenches until they upgrade</li>
                        </ul>
                        <h4 class="card-subtitle mb-3">Free</h4>
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header bg-success text-white">
                        <h3 class="card-title">Odogwu - Classy Lady</h3>
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <li>Unlimited access to everyone</li>
                            <li>Unlimited rewinds</li>
                            <li>Ability to change location</li>
                            <li>Unlimited rematch</li>
                            <li>50 matches daily</li>
                        </ul>
                        <h4 class="card-subtitle mb-3">$14.99/mo</h4>
